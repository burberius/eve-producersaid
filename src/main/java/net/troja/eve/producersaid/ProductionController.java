...
public class ProductionController {
    ...
    public List<BlueprintProduction> query(@RequestParam(value = "ids", defaultValue = "35") final String ids,
            @RequestParam(value = "system", defaultValue = "Jita") final String system) {
        final List<BlueprintProduction> result = new ArrayList<BlueprintProduction>();
